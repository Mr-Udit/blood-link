    ...
    <Sheet className="bg-red-700">
      ...
      <SheetContent className="flex bg-red-700 flex-col" >
        <SheetHeader className="flex flex-col items-center justify-between mt-2">
          <SheetTitle><HeartPulse size={30} className="text-white" />
            <h1 className="text-white font-semibold" >Blood Link</h1></SheetTitle>
        </SheetHeader>
        <nav className="flex flex-col space-y-4">
          <ul className=" flex text-white list-none ml-[-50px] flex-col items-center justify-center font-medium">
            <li className="mr-4 mt-4" style={{ textTransform: "capitalize" }}>
              <Link to="/">home</Link>
            </li>
            <li className="mr-4 mt-4" style={{ textTransform: "capitalize" }}>
              <Link to="/">about</Link>
            ...
            <li className="mr-4 mt-4 mb-4" style={{ textTransform: "capitalize" }}>
              <Button variant="outline" className="text-white bg-red-700">Donate Now <ArrowRight /> </Button>
            </li>
            <li>
              <SignedOut>
